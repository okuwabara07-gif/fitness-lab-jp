...
const TOPIC = 'フィットネス・ジム・宅トレ器具';
const CRITERIA = '効果・使いやすさ・コスパ・耐久性・口コミ';
const A8_PRODUCT_NAME = 'LAVA ホットヨガ';
const A8_PRODUCT_URL = 'https://px.a8.net/svt/ejp?a8mat=4AZR8U+DGLC7E+3HM8+614MN';
const A8_PRODUCT_DESC = '全国展開の人気ホットヨガスタジオ';
